...
//      while (i);
    ...
    if (anim == RT_NULL)
    {
        ...
        rtgui_anim_set_bg_buffer(anim, (struct rtgui_dc*)bg_buf);
        rtgui_anim_set_fg_buffer(anim, (struct rtgui_dc*)dc_buffer, 1);
        rtgui_anim_set_onfinish(anim, _update_engctx,0);
